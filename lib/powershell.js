...
exports.leftDown = function () {
  return `[Clicker]::LeftDown()\n`
};
exports.leftUp = function () {
  return `[Clicker]::LeftUp()\n`
};
exports.rightClick = function () {
  return `[Clicker]::RightClick()\n`
};
exports.rightDown = function () {
  return `[Clicker]::RightDown()\n`
};
exports.rightUp = function () {
  return `[Clicker]::RightUp()\n`
};
